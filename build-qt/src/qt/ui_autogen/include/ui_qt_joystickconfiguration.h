...
public:
    ...
    void setupUi(QDialog *JoystickConfiguration)
    {
        if (JoystickConfiguration->objectName().isEmpty())
            JoystickConfiguration->setObjectName("JoystickConfiguration");
        ...
        comboBoxDevice->setObjectName("comboBoxDevice");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, JoystickConfiguration, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, JoystickConfiguration, qOverload<>(&QDialog::reject));
